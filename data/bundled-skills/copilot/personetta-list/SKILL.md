...
description: >-
  ...
  CLI. The host agent (GitHub Copilot here) is auto-detected. Use when the user
  asks what recipes or personas exist before switching.
---
...
format is auto-detected from the host agent, GitHub Copilot here).
