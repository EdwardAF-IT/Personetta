...
description: >-
  ...
  CLI. Use when the user asks what recipes or personas exist, available Role
  Forge roles, or to list recipes before switching.
---
...
Summarize the results: recipe **names** are the ids to pass to
`personetta set-active <name>` (the format is auto-detected from the host agent).
